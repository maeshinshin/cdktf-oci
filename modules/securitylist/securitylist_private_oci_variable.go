...
const (
	defaultPrivateSecurityListName = "securitylist-private-cdktf-oci"
)

var defaultPrivateIngressSecurityRules = &[]*coresecuritylist.CoreSecurityListIngressSecurityRules{
	{
		Description: jsii.String("Allow ssh traffic from the VCN CIDR block"),
